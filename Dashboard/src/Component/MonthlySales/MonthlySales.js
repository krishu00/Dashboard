...
const MonthlySale = (props) => {
  ...
  useEffect(() => {
    const colors = ["#0088FE", "#00C49F", "#717116", "#D15C5C", "#14261B" ,"#45C7BF" , "#BF9898" ,"#FF8042" , "#711616" ,"#11F1D3" ,];
  ...
  Object.keys(object).forEach((key) => {
    ...
    if (key === 'Monthly Sales') {
      ...
      data_new[count_number1++].uv = valueInLakh.toFixed(2);
        ...
        const chartData = Monthly_Sale_rs.map(({ 'Month':Month, 'Monthly Sales': MonthlySales }, index) => ({
